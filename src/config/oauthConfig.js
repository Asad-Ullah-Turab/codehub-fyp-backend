...
console.log('🔍 OAuth Configuration Loading...');
...
export const initializeGoogleStrategy = () => {
  if (process.env.GOOGLE_CLIENT_ID && process.env.GOOGLE_CLIENT_SECRET) {
    ...
    console.log('❌ Google OAuth strategy NOT initialized (missing credentials)');
    return false;
  }
};
...
export const initializeGitHubStrategy = () => {
  if (process.env.GITHUB_CLIENT_ID && process.env.GITHUB_CLIENT_SECRET) {
    ...
    console.log('❌ GitHub OAuth strategy NOT initialized (missing credentials)');
    return false;
  }
};
